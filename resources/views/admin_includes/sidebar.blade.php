...
<style>
  .logo {
    ...
    color: #435ebe; /* Logo color */
    text-decoration: none; /* Remove underline */
    font-family: Arial, sans-serif; /* Set font */
}
.logo:hover {
    color: #41bbdd; /* Add hover effect */
}
</style>
      ...
      <ul class="menu">
        ...
        <li class="sidebar-item has-sub">
          ...
          <ul class="submenu">
            <li class="submenu-item">
              <a href="{{ route('students.view') }}" class="submenu-link"
                >View </a
              >
            </li>

            <li class="submenu-item">
              <a href="{{ route('students.free.courses') }}" class="submenu-link"
                >Enrolled for free courses </a
              >
            </li>
        ...
        <li class="sidebar-item has-sub">
         ...
         <li class="sidebar-item has-sub">
          ...
          <ul class="submenu">
            <li class="submenu-item">
              <a href="{{route('pending.reviews') }}" class="submenu-link"
                >Pending Reviews</a
              >
            </li>

            <li class="submenu-item">
              <a href="{{ route('active.reviews') }}" class="submenu-link"
                >Active Reviews</a
              >
            </li>

            <li class="submenu-item">
              <a href="{{ route('declined.reviews') }}" class="submenu-link"
                >Declined Reviews</a
              >
            </li>
