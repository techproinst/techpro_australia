...
<head>
  ...
  <title>Application Number :: Mail</title>
</head>
<body>
  ...
  <div class="container">
    <div class="card mt-2">
        ...
        <div class="card-body">
        <p> Congratulations! Your application number has been processed successfully</p>
        ...
        <a href="{{ route('page.details') }}">
          <button style="background-color: #fc3468;" type="button" class="btn text-white">Proceed to verify your application details</button>
        </a>
